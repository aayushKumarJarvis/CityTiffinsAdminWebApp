...
<body>
<div id="main">
    <h1><?php echo $_POST['name'].'\'s'?>, Tiffin Center Not Registered</h1>
    <div id="box">
        <br><br>
        <a href="AddTiffinCenter.php" class="btn btn-primary btn-large"><i class="icon-white icon-repeat"></i>Register Again</a>
        <br><br>
